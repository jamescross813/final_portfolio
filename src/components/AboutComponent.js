            ...
            <div className="row">
                ...
                <div className="col-sm-4 text-light">
                            <h1 className="title">About</h1>
                                ...
                                <p className="row">I got into coding as a hobby, then delved deeper through Flatiron.<br/> Since graduating I've continued my studies, expanded my knowledge base and gotten to use the skills learnt in the real world!</p>
                </div>
            </div>
            </>
        )
